function json_beautify(str) {
	...
	buffer_write(rb, buffer_string, str);
	...
	if (start == 0) return str; // source string was unchanged
	buffer_write_slice(rb, fb, start, pos);
...
function lag() {
	return delta_time * gamespeed_fps * 0.000001
}
